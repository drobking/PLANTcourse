...
namespace PlantCourse.Migrations
{
    ...
    [Migration("20201109141410_4Name")]
    partial class _4Name
    {
            ...
            modelBuilder.Entity("DataAccess.Entity.UserAdditioanalInfo", b =>
                {
                    b.HasOne("DataAccess.Entity.User", "User")
                        .WithOne("UserAdditioanalInfo")
                        .HasForeignKey("DataAccess.Entity.UserAdditioanalInfo", "Id")
